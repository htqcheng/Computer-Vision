...
x_cov = np.array([[0,0,349,349],[1,439,439,0]]).T
# x_desk = np.array([[0,0,349,349],[1,439,439,0]]).T
# x_cov = np.array([[0,0,349,349],[1,439,439,0]]).T

# homography = computeH_norm(x_desk, x_cov)
homography,_ = computeH_ransac(x_desk, x_cov, opts)

print(homography)
x_desk_homo = np.array([[240, 163, 577, 498],[194,493,485,190],[1,1,1,1]],dtype=float)
x_cov_homo = np.array([[0,0,349,349],[1,439,439,0],[1,1,1,1]], dtype=float)
